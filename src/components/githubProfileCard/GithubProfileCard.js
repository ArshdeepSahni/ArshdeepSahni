        ...
        <div className="row">
          <div className="main-content-profile">
            ...
            <div className="opp-div">
              {/* <span className="desc-prof">Open for opportunities:  <span className="heart-emoji">{emoji("✅")}</span> {prof.hireable}</span> */}
            </div>
            <SocialMedia />
          </div>
          <div className="image-content-profile">
            <a href="https://github.com/arshdeepsahni"><img src={prof.avatarUrl} alt={prof.name} className="profile-image" /></a>
          </div>
        </div>
      </div>
    </Fade>
